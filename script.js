...
let historico_mensagens = document.querySelector('.historico_mensagens')
...
btn_enviar.addEventListener('click', (evento) => {
    ...
    historico_mensagens.append(caixa_mensagem)
    historico_mensagens.append(editar_excluir)
})
